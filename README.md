...
- 紫微斗數：十二宮、命身主、五行局、主輔星、亮度、四化與大限範圍。
...
- iPhone／iPad 使用 220 token 短篇增強，再與完整規則報告合併；90 秒沒有完成會中止並重設 Worker。其他裝置上限 320 token／150 秒。
- Qwen3 的思考模式明確關閉；首 token 與串流停滯各有 watchdog，不會無限顯示生成中。
...
- 紫微斗數先採 iztro 通行排法；不同流派的四化、亮度、晚子時與閏月規則可能不同，尚未加入流年盤與三方四正互動解讀。
