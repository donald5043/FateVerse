...
- 探索命盤：公曆／農曆、四柱、藏干、十神、十二長生、旬空、胎元／胎息／命宮／身宮與八組大運。
- 五行分析：八個天干地支主五行的數量、比例與相對強弱。
- 紫微斗數：十二宮、命身主、五行局、主輔星、亮度、四化、可選日期的大限／流年／流月／流日與命宮三方四正。
- 西洋星盤：十個星體的地心黃道位置、太陽／月亮星座、逆行與主要相位；提供經緯度時加入上升與等宮制十二宮。
...
- 西洋星盤尚未加入 Placidus 等不等宮制；未提供經緯度時不計算上升與宮位。
- 紫微斗數採 iztro 通行排法，已顯示目前日期的大限／流年四化與命宮三方四正；不同流派的四化、亮度、晚子時與閏月規則仍可能不同。
...
- 拖曳式圖片裁切、透視校正與多語 OCR。
- 正式康熙字典資料與可驗證的筆畫來源。
- 加入西洋星盤更多宮制、相位權重與可切換的熱帶／恆星黃道研究。
- 加入紫微流派設定頁與不同四化表的可比較模式。
